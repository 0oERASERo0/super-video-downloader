...
@Database(
    entities = [PageInfo::class, SupportedPage::class, VideoInfo::class, ProgressInfo::class, HistoryItem::class, RemoteVideoInfo::class],
    version = DB_VERSION,
)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun remoteVideoDao(): RemoteVideoDao
}